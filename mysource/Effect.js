...
(function () {
    ...
    function s(t, i, n) {
        var e = new l; e.init(t, i, n), f.push(e)
    }
    function h() {
        for (var t = 0; t < f.length; t++)f[t].update(); for (t = f.length - 1; t >= 0; t--)f[t].lifeSpan < 0 && (f[t].die(), f.splice(t, 1))
    }
    function a() {
        ...
        this.character = "*",
            ...
            this.init = function (t, i, n) {
                this.velocity = { x: (Math.random() < .5 ? -1 : 1) * (Math.random() / 2), y: 1 },
                    ...
                    this.initialStyles.color = n, console.log(n),
    ...
    var r = ["#D61C59", "#E7D84B", "#1B8798"], d = window.innerWidth, u = (window.innerHeight, { x: d / 2, y: d / 2 }), f = [];
    t()
})();
*/